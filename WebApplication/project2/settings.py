...
SECRET_KEY = 'django-insecure-8)7f)oiuho+k$m-#ygk4sc!^2=i7=x9dq6^h#+&$*k#sgpe9np'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # Make sure Redis is running on your system
        'OPTIONS': {
...
# For improved performance, you can also configure Redis as a cache backend
